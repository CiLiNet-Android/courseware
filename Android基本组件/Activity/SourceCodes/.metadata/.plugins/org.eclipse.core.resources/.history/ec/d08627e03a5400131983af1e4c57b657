...
public class Activity_1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button btn_launchMode_singleTask_startActivity_2 = (Button)super.findViewById(R.id.btn_launchMode_singleTask_startActivity_2);
		...
		Button btn_launchMode_singleTask_startActivity_1_1 = (Button)super.findViewById(R.id.btn_launchMode_singleTask_startActivity_1_1);
