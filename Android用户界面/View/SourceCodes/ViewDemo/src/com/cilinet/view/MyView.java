...
//	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		mOnMyViewDidListener.did(this);
		
		return super.onTouchEvent(event);
	}
	
	public interface OnMyViewDidListener {
		public void did(View v);
	}
	
	private OnMyViewDidListener mOnMyViewDidListener;

	public void setOnMyViewDidListener(OnMyViewDidListener mOnMyViewDidListener) {
		this.mOnMyViewDidListener = mOnMyViewDidListener;
	}
